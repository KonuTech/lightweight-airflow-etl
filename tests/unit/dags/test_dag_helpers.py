...
Proves the sorted-first-match/no-match behavior and that the SAME helper
...
def test_resolve_matched_file_returns_sorted_first_match(tmp_path: Path) -> None:
    ...
    assert result.name == "customers_20260101.csv"
